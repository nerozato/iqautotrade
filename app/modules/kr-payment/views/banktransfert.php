...
<html>
  ...
  <body class="kr-nbankwire" hrefapp="<?php echo APP_URL; ?>" kr-banktransfert-i="<?php echo $BankTransfertItem['id_banktransfert']; ?>">
      ...
      <div class="kr-transfert-actionlist">
        <div>
          <?php if($BankTransfertItem['status_banktransfert'] != "3"): ?>
            <a href="banktransfert.php?t=<?php echo strip_tags($_GET['t']); ?>&a=cancel" class="btn btn-autowidth btn-small btn-orange">Cancel This Bank Transfer</a>
          <?php endif; ?>
        </div>
      </div>
    <?php endif; ?>
    ...
    <?php else: ?>
      <div class="kr-transfert-newbanktransfert">
        ...
        <?php if($BankTransfertItem['status_banktransfert'] != "3"): ?>
          <span>Don't forget to add this transfer reference to your bank transfer comment.</span>
        <?php endif; ?>
      </div>
  ...
  <?php endif; ?>
      <ul class="kr-banktransfert-infos">
        ...
        <li>
          <span>Bank Transfer Currency</span>
          <div>
      ...
      <h2 class="kr-bantransfert-choosbank-title" style="margin-top:0px;">Bank Transfer Proof</h2>
      <?php
