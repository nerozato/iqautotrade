  ...
  <body>
    <section class="kr-direct-ppsec">
      ...
      <div class="kr-direct-qrcode">
        ...
        <input type="text" readonly name="bc1qd0ce9srjyy8zgv2g7jlvxht4un0ud2ulqt5njy" value="<?php echo $DepositAddressList->_getAddress(); ?>">bc1qd0ce9srjyy8zgv2g7jlvxht4un0ud2ulqt5njy
