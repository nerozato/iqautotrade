...
<?php endif; ?>
  ...
  <div class="kr-admin-line kr-admin-line-cls">
    ...
    <div class="kr-admin-field">
      <div>
        <label><?php echo $Lang->tr('Bank transfer payment Fees (in %)'); ?></label>
      </div>
      <div>
        <input type="text" placeholder="<?php echo $Lang->tr('Your bank transfer payment fees (in %)'); ?>" name="kr-adm-banktransfertfees" value="<?php echo $App->_getBankTransfertPaymentFees(); ?>">
      </div>
    </div>
  </div>
