    ...
    <table>
      ...
      <tr id="kr-email-maintext">
        <td>
          ...
          <p>Congratulations! We are delighted to have you on our team. Your experience will be a terrific asset to our company. {{ APP_TITLE }} Let’s have a great time working together! {{ CONTACT_EMAIL }}</p>
        </td>
      </tr>
