  ...
  <body>
    <table>
      ...
      <tr id="kr-email-maintext">
        <td>
          <h3>Hi, {{ USER_NAME }} !</h3>
          <h4>You have made a new widthdrawal request ({{ AMOUNT }}), date : {{ DATE }}</h4>
          <ul>
            {{ INFOS_WITHDRAW }}
          </ul>
          <p>Please, confirm the widthdrawal request, if you this request is not from you please contact the support.</p>
        </td>
      </tr>
      <tr id="kr-email-button">
        <td>
          <a href="{{ CONFIRM_LINK }}">Confirm widthdrawal</a>
        </td>
      </tr>
